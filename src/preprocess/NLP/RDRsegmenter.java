...
{
    private Node root;
	public RDRsegmenter() throws IOException
    {
        this.constructTreeFromRulesFile("src/preprocess/Model.RDR");
    }
    ...
    public String segmentRawString(String str) throws IOException
    {
    	str = str.toLowerCase();
        ...
        throws IOException
    {
        ...
        for (String line; (line = buffer.readLine()) != null;) {
            ...
            for (String sentence : Tokenizer.joinSentences(Tokenizer.tokenize(line))) {
                ...
                System.out.println(segmentTokenizedString(sentence));
            }
        }
        for (String line; (line = buffer.readLine()) != null;) {
            bw.write(segmentTokenizedString(line) + "\n");
